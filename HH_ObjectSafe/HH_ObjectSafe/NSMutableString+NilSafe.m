...
#import "NSMutableString+NilSafe.h"
#import "NSObject+NilCrash.h"

@implementation NSMutableString (NilSafe)
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [NSObject hh_exchangeInstanceMethodWithClass:NSClassFromString(@"__NSCFString")
