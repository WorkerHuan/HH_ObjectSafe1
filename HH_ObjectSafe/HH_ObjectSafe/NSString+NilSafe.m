...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [NSObject hh_exchangeInstanceMethodWithClass:NSClassFromString(@"__NSCFConstantString")
                                     originalSelector:NSSelectorFromString(tmpSubFromStr)                                     swizzledSelector:NSSelectorFromString(tmpSafeSubFromStr)];
        
        [NSObject hh_exchangeInstanceMethodWithClass:NSClassFromString(@"NSTaggedPointerString")
